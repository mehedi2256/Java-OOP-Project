...
public class Main {
    public static void main(String[] args) {
        ...
        while (choice) {
            ...
            try {
                if (first < 1 || first > 5)
                    throw new Exception("Error: Invalid input. Try again");
                else {
                    switch (first) {
                        case 1:
                            ...
                            try {
                                if (second1 < 1 || second1 > 4)
                                    throw new Exception("Eroor: Invalid input. Try again");
                                else {
                                    switch (second1) {
                                        case 1:
